# The Financial Times Stock Exchange 100 Index is a share index of the 100 companies by capital value listed on the 
...
ftse_100_to_ib_map = {d['symbol']: d['IB'] for d in ftse_100}